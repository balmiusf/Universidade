 ...
 * @throws InvalidNodeException 
  ...
  public static void main(String[] argv) throws InterruptedException, InvalidNodeException {
    Ocean sea;
   ...
   // RunLengthEncoding sea2 = new RunLengthEncoding(sea);
    ...
    //RunLengthEncoding test = new RunLengthEncoding(sea);
    //sea = sea2.toOcean();
    ...
    while (true) {                                              // Loop forever
      Thread.sleep(100);                // Wait one second (1000 milliseconds)
      ...
      //test = new RunLengthEncoding(sea);
      //sea = test.toOcean();
