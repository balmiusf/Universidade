...
public class Questao_QQSM {
	...
	public void add_para_ficheiro() throws IOException{
		try{
		QQSM ficheiro = new QQSM();			//objecto temp.
		
		FileWriter fw = new FileWriter(ficheiro.getFiness(),true);	//modo append = true, 
		BufferedWriter bw = new BufferedWriter(fw);
		bw.append(toString());			//adiciona ao ficheiro o que tiver em toString()
		bw.close();
